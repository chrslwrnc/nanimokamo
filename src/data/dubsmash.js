export default {
  ...
  points: [
    ...
    },
    {
      title: 'Bundle size',
      shortBody:
        'Set up tree-shaking using Webpack, moved rarely-changed vendor files in to a separate, more agressively cached, bundle, and separated each individual part of the site in to bundles based on user flow.',
      body:
    ...
    },
    {
      title: 'Observables',
      shortBody:
        'Used <a href="https://github.com/ReactiveX/rxjs">RxJs</a> to make dealing with asynchronous events easier.',
      body:
